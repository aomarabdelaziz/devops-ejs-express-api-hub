...
resource "aws_iam_role_policy_attachment" "AmazonEC2ContainerRegistryFullAccessMaster" {
...
resource "aws_iam_role_policy_attachment" "AmazonEC2ContainerRegistryFullAccessWorker" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryFullAccess"
  role       = aws_iam_role.worker.name
}
